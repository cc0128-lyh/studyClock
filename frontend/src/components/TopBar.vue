    ...
    <div class="top-left">
      <div class="user-info" @click="$router.push('/settings')">
        <div class="mini-avatar" :style="avatarBgStyle">
          ...
          <img v-else :src="userStore.avatarUrl" alt="" />
        </div>
...
.router-link-active { color: #fff !important; background: rgba(255,255,255,0.1); }
.clock-text { font-family: var(--font-mono); font-size: 0.85rem; opacity: 0.7; }
.top-btn {
